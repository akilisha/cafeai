...
dependencies {
    ...
    implementation 'com.akilisha.oss:cafeai-agents:0.2.1'
    implementation 'com.akilisha.oss:cafeai-rag:0.2.1'
    implementation 'com.akilisha.oss:cafeai-memory:0.2.1'
    implementation 'com.akilisha.oss:cafeai-guardrails:0.2.1'
    implementation 'com.akilisha.oss:cafeai-observability:0.2.1'
    implementation 'com.akilisha.oss:cafeai-security:0.2.1'
    implementation 'com.akilisha.oss:cafeai-connect:0.2.1'
