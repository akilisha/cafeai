 ...
 *
 * <ul>
 *   <li>{@code GEMINI_LIVE_MODEL} — a fast model that reads images (default {@code gemini-2.5-flash}).</li>
 * </ul>
 */
@DisplayName("Gemini — live")
class GeminiLiveTest extends ProviderLiveSuite {

    private final String model = env("GEMINI_LIVE_MODEL", "gemini-2.5-flash");
