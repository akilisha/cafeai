...
/**
 * OpenAI provider factory for CafeAI.
 *
 * <pre>{@code
 *   app.ai(OpenAI.gpt4o());
...
public final class OpenAI {
    ...
    public static AiProvider gpt4o() {
        return of("gpt-4o");
    }

    public static AiProvider gpt4oMini() {
        return of("gpt-4o-mini");
    }

    public static AiProvider o1() {
        return of("o1");
    }

    public static AiProvider o1Mini() {
        return of("o1-mini");
    }
