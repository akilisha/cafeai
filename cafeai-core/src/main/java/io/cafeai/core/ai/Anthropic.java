...
/**
 * Anthropic Claude provider factory for CafeAI.
 *
 * <pre>{@code
...
public final class Anthropic {
    ...
    public static AiProvider claude35Sonnet() {
        return of("claude-3-5-sonnet-20241022");
    }

    public static AiProvider claude3Opus() {
        return of("claude-3-opus-20240229");
    }

    public static AiProvider claude3Haiku() {
        return of("claude-3-haiku-20240307");
    }
